...
>
> Attention is the finite, volatile *fuel* an actor burns — in iterative motion (decision → action → result → learning) — toward an outcome-*anchor*. Every axiom below is a discipline for burning it well.
>
...
- **Forbids:** mixed concerns in one unit; bleed across the seam.
